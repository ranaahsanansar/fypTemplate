...
function createData(society , block , propertyId , shares , amountPerShare , seller, buyer , status , contract) {
  return { society , block , propertyId , shares , amountPerShare , seller, buyer , status , contract};
}

const rows = [
  createData('Bahria' , 'A' , '786' , 20 , 5000 , 'Ahsan Ansar'  , 'Talal' , true , '9X00390g0s2094099430gh0294509dfgh0'  ),
  createData('Bahria' , 'B' , '786' , 20 , 5000 , 'Ahsan Ansar'  , 'Talal' , true , '9X00390g0s2094099430gh0294509dfgh0'  ),
  createData('Bahria' , 'X' , '786' , 20 , 5000 , 'Ahsan Ansar'  , 'Talal' , false , '9X00390g0s2094099430gh0294509dfgh0'  ),
  createData('Bahria' , 'Y' , '786' , 20 , 5000 , 'Ahsan Ansar'  , 'Talal' , true , '9X00390g0s2094099430gh0294509dfgh0'  ),
  createData('Bahria' , 'Z' , '786' , 20 , 5000 , 'Ahsan Ansar'  , 'Talal' , false , '9X00390g0s2094099430gh0294509dfgh0'  ),
];
